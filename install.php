  ...
  <body>
    <div class="container main_body"> <div class="section" >
      <div class="column is-6 is-offset-3">
        ...
        <div class="box">
            <div class="notification is-success"><b>BAŞARILI!</b> NacssWeb başarıyla kuruldu. İyi kullanımlar.</div>
</body>
</html>
        <?php
      ...
      <div class="column is-6 is-offset-3">
        ...
        <div class="box">
          <form action="" method="POST">
            <div class="notification is-primary">NacssWeb kurulumuna hoşgeldiniz!</div>
            <div class="field">
